...
• Drag to select date ranges and see totals
• Paginated navigation through your complete history

**Tank tracking (optional)**
...
• Medium widget: calendar heatmap on your home screen
• Tank widget: fill percentage gauge

**Smart notifications**
• Leak detection: alerts when usage spikes above normal
• Tank warnings: know when it's time to pump
• Salt reminders: never run out unexpectedly
• Device offline alerts

**Export your data**
• CSV or PDF reports with custom date ranges
...
• Smart notifications for usage spikes, tank alerts, and salt reminders
...
1. **Dashboard** — Hero metric + calendar heatmap + tank bar
2. **Usage History** — Chart with 30D view and summary stats
3. **Tank Tracking** — Circular gauge with pump history
4. **Widgets** — Home screen with usage and tank widgets
5. **Export** — Share sheet with CSV/PDF options
6. **Onboarding** — "Your Water Data, Unlocked" welcome screen
